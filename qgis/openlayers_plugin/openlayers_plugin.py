...
class OpenlayersPlugin:
  ...
  def __init__(self, iface):
    ...
    self.olLayerTypeRegistry.add( OlLayerType(self, 'hgis wig 500k', 'hgis_icon.png', 'hgis_wig500k.html', True) )
    self.olLayerTypeRegistry.add( OlLayerType(self, 'hgis wig 300k', 'hgis_icon.png', 'hgis_wig300k.html', True) )
    self.olLayerTypeRegistry.add( OlLayerType(self, 'hgis wig 100k', 'hgis_icon.png', 'hgis_wig100k.html', True) )
    self.olLayerTypeRegistry.add( OlLayerType(self, 'hgis wig 25k', 'hgis_icon.png', 'hgis_wig25k.html', True) )
    self.olLayerTypeRegistry.add( OlLayerType(self, 'hgis mb 25k', 'hgis_icon.png', 'hgis_mb25k.html', True) )
    self.olLayerTypeRegistry.add( OlLayerType(self, 'hgis ukvme 300k', 'hgis_icon.png', 'hgis_ukvme300k.html', True) )
    self.olLayerTypeRegistry.add( OlLayerType(self, 'hgis kdr 100k', 'hgis_icon.png', 'hgis_kdr100k.html', True) )
    self.olLayerTypeRegistry.add( OlLayerType(self, 'hgis kdwr 100k', 'hgis_icon.png', 'hgis_kdwr100k.html', True) )
    self.olLayerTypeRegistry.add( OlLayerType(self, 'hgis kdr_gb 100k', 'hgis_icon.png', 'hgis_kdr_gb100k.html', True) )
    # Overview
